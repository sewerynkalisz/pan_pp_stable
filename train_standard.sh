...
# ICDAR2015
#nohup python train_ic15.py --arch resnet18 --img_size 640 --short_size 640 > icdar2015_train.out &
nohup python train_ic15.py --arch resnet18 --img_size 640 --short_size 640 --pretrain /workspaces/pan_pp_stable/checkpoints/synth_resnet18_640/checkpoint_0ep.pth.tar > ic15_pretrain.out &